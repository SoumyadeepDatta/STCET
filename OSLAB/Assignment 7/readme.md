# Signal Handling in Linux Part-II
1. Write a program to kill the child process from parent process using SIGNAL.
### Examples
Use of sigint (^C)
```c
//Use of sigint (^C)
...
void oh(int sig)
{
	...
	signal(SIGINT,oh);
	/* THIS LINE WILL CONTINUE THE EXECUTION OF FUNCTION
	 * OH 
	*/
